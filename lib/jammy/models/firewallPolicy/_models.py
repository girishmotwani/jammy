...
class ExplicitProxySettings(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.enable_explicit_proxy = kwargs.get('enable_explicit_proxy', None)
        self.http_port = kwargs.get('http_port', None)
        self.https_port = kwargs.get('https_port', None)
        self.pac_file_port = kwargs.get('pac_file_port', None)
        self.pac_file = kwargs.get('pac_file', None)
...
class FirewallPolicy(Resource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.explicit_proxy_settings = kwargs.get('explicit_proxy_settings', None)
...
class IDPSQueryObject(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.results_per_page = kwargs.get('results_per_page', None)
...
class QueryResults(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.matching_records_count = kwargs.get('matching_records_count', None)
...
class SignatureOverridesFilterValuesResponse(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.filter_values = kwargs.get('filter_values', None)
...
class SingleQueryResult(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.signature_id = kwargs.get('signature_id', None)
        self.mode = kwargs.get('mode', None)
        ...
        self.description = kwargs.get('description', None)
        self.protocol = kwargs.get('protocol', None)
        self.source_ports = kwargs.get('source_ports', None)
        self.destination_ports = kwargs.get('destination_ports', None)
        self.last_updated = kwargs.get('last_updated', None)
        self.inherited_from_parent_policy = kwargs.get('inherited_from_parent_policy', None)
